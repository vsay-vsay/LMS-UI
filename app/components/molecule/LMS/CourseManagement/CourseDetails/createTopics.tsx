...
export function TopicsAddSectionForm({ open, onOpenChange, onSuccess }: SheetDemoProps) {
    useEffect(() => {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent>
                <SheetHeader>
                    <SheetTitle>Create Topics</SheetTitle>
                    <SheetDescription>
                        Create new Topic here. Click save when you're done.
                    </SheetDescription>
                </SheetHeader>
