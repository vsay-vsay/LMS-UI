...
import { getPublicCourses, getCoursePublicFeatures } from '../../../../routes/LMS/PublicCourse/api';
...
const CourseSelectionPublicPage = () => {
        ...
        const fetchCourses = async () => {
            try {
                ...
                const transformedCourses = apiCourses.map(course => ({
                    ...
                    features: getCoursePublicFeatures(course),
                    tutor: course.tutor
                }));
...
export default CourseSelectionPublicPage;